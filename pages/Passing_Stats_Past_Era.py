...
st.markdown("""
Ranking the Quarterbacks of this season based on the criteria of Completion Percentage, Passing Yards, Passing Touchdowns, Touchdown Percentage, Interception Percentage, and Passer Rating!
